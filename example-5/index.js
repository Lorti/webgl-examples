...
function initBuffers(gl) {
  ...
  // positionBuffer.numItems = teapot.ertexPositions.length / 3;
...
function drawScene(gl, programInfo, buffers, texture, deltaTime) {
  ...
  mat4.rotate(
    modelViewMatrix, // destination matrix
    modelViewMatrix, // matrix to rotate
    teapotRotation, // amount to rotate in radians
    [0, 0, 1],
  ); // axis to rotate around (Z)
  mat4.rotate(
    modelViewMatrix, // destination matrix
    modelViewMatrix, // matrix to rotate
    teapotRotation * 0.7, // amount to rotate in radians
    [0, 1, 0],
  ...
  {
    const vertexCount = teapot.indices.length;
